...
namespace WanFramework.Sequence
{
    ...
    public class SequenceSystem : SystemBase<SequenceSystem>
    {
        ...
        /// </summary>
        /// <param name="sequencePlaying"></param>
        public void Stop(ISequencePlaying sequencePlaying)
        {
        ...
        /// </summary>
        /// <param name="owner"></param>
        public void StopAll(Behaviour owner)
        {
        ...
        private void UpdateAllSequence()
        {
            ...
            for (var i = 0; i < _currentSequence.Count; ++i)
            {
                ...
                {
                    _currentSequenceCallback[i]?.Invoke();
                    SetSequenceInactivateAt(i);
                }
            }
    ...
    public static class SequencePlayingExtension
    {
        ...
        public static void Stop(this ISequencePlaying sequencePlaying)
        {
            SequenceSystem.Instance.Stop(sequencePlaying);
        }
        ...
        public static void StopAllSequence(this Behaviour behaviour)
        {
            SequenceSystem.Instance.StopAll(behaviour);
        }
    }
}